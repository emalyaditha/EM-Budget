          ...
          {toasts.map((toast) => (
            <motion.div
              ...
              className={`p-4 rounded-xl shadow-lg border flex items-center gap-3 backdrop-blur-sm w-full max-w-[300px]
                ${toast.type === 'success' ? 'bg-blue-900/80 border-blue-500 text-blue-100' : 
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-blue-500 text-neutral-950 rounded-lg hover:bg-blue-600 transition"
                >Confirm</button>
              </div>
            </motion.div>
          </div>

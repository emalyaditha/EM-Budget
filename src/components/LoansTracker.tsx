        ...
        <form onSubmit={handleGiveLoanSubmit} className="bg-zinc-905/30 bg-zinc-950/15 border border-[var(--accent-primary)]/30 p-6 rounded-2xl space-y-4 animate-fade-in relative overflow-hidden" id="add-loan-form-panel">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block font-mono">Borrower Name (Debtor)</label>
              <input
                type="text"
                ...
                required
              />
              {errors.borrowerName && <p className="text-[10px] text-rose-500 font-semibold">{errors.borrowerName}</p>}
            </div>

            {/* Total Principal Amount */}
            <div className="space-y-1.5">
              <label className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block font-mono">Principal Amount Lent ({currency})</label>
              <input
                type="number"
                step="any"
                placeholder="0.00"
                ...
                required
              />
              {errors.totalAmount && <p className="text-[10px] text-amber-500 font-semibold leading-normal">{errors.totalAmount}</p>}
            </div>

            {/* Source Debit Ledger Account */}
            <div className="space-y-1.5">
              <label className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block font-mono">Debit Funds From Account</label>
              <select
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Private Notes */}
            <div className="space-y-1.5">
              <label className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block font-mono">Notes / Memorandum</label>
              <input
                type="text"
                placeholder="e.g. Friendly loam, paid back in weekly installments..."
                value={notes}
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button
              ...
              className="bg-transparent hover:bg-zinc-900 border border-zinc-850 text-zinc-400 hover:text-white py-2.5 px-6 rounded-xl text-xs font-bold transition-all cursor-pointer"
            >
              Cancel Setup
            </button>
            <button
              ...
              return (
                ...
                >
                  ...
                  {settlingLoanId === loan.id && (
                    <form onSubmit={handleSettleSubmit} className="mt-4 bg-[#0a0a0d] border border-indigo-905 p-5 rounded-2xl space-y-3.5 shadow-inner scale-98 transition-all animate-fade-in text-xs">
                      <div className="flex items-center gap-1 text-indigo-405 font-bold mb-1">
                        <CheckCircle2 size={13} className="text-indigo-400" />
                        <span className="uppercase font-mono text-[10px] text-indigo-400 tracking-wider">Configure Settlement Credit Transaction</span>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] text-zinc-500 uppercase font-bold font-mono">Settled Value ({currency})</label>
                          <input
                            type="number"
                            step="any"
                            ...
                            className="w-full bg-zinc-950 border border-zinc-850 rounded-lg py-2.5 px-3 text-xs text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all font-semibold"
                            required
                          />
                        </div>
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] text-zinc-500 uppercase font-bold font-mono">Credit Destination Account</label>
                          <select
                            ...
                            className="w-full bg-zinc-950 border border-zinc-850 rounded-lg py-2.5 px-2 text-xs text-white focus:outline-none focus:border-indigo-500 transition-all cursor-pointer font-bold"
                          >
                            {availableAccounts.map(acc => (

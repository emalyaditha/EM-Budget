                ...
                <div className="flex justify-between items-center text-[11px] mono">
                  ...
                  {resendTimer > 0 ? (
                    ...
                    <button
                      ...
                      onClick={() => initOtpSend()}
                      disabled={loading || rateLimitTimer > 0}
                      className="text-[var(--ink)] underline underline-offset-4 decoration-[var(--line-strong)] hover:decoration-[var(--ink)]"
                    >
                      Resend code
                    </button>
                  )}
          ...
          <AnimatePresence>
            {rateLimitTimer > 0 && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -4 }}
                className="mt-3 rounded-xl border border-[var(--line)] bg-[var(--warning-bg,var(--surface-2))] px-3.5 py-3 flex gap-2.5 text-[12px] leading-5 text-[var(--ink-2)]"
              >

                    ...
                    <div className="flex justify-end gap-3 mt-3 pt-2.5 border-t border-border">
                      {!notif.read && (
                        <button
                          ...
                          className="text-[10.5px] text-emerald-600 dark:text-emerald-400 font-bold font-mono uppercase flex items-center gap-1 hover:text-emerald-500 cursor-pointer"
                        >

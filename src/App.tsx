        ...
        <aside className={`hidden lg:flex flex-col h-screen fixed top-0 left-0 bg-[#08080c]/90 border-r border-zinc-850/65 backdrop-blur-md transition-all duration-300 z-30 p-5 ${
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center pointer-events-auto">
              {!isNavCollapsed && (
                <span className="text-[9px] font-mono tracking-widest text-[var(--text-muted)] uppercase font-bold flex items-center gap-1.5">
                          ...
                          return (
                            ...
                            >
                              <div className="flex justify-between items-center w-full">
                                ...
                                {isActive && <span className="w-1.5 h-1.5 bg-black rounded-full animate-pulse" />}
                              </div>
                              <div>
                                <span className="text-[11px] font-bold block">{item.title}</span>
                                <span className={`text-[8.5px] block ${isActive ? 'text-black/85 font-medium' : 'text-[var(--text-secondary)]'}`}>{item.desc}</span>
                              </div>
                            </button>
                          );
                        })}
